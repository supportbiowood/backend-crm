    ...
    <body>
        <div class="info">
            <div class='info_left'>
                ...
                วันที่ / Date : ${data.sales_order_issue_date} <br>
                ใช้ได้ถึง / Expire Date : ${data.sales_order_due_date}
            </div>
            <div class='info_right'>
                ใบสั่งขาย / SalesOrder : ต้นฉบับ / Original <br>
                เลขที่เอกสาร / Document No. : ${data.sales_order_document_id} <br>
